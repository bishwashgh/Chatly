...
const styles = StyleSheet.create({
  ...
  closeBtn: { position: 'absolute', right: 0, top: 0, width: 34, height: 34, borderRadius: radii.full, backgroundColor: 'rgba(239,248,246,0.92)', alignItems: 'center', justifyContent: 'center' },
